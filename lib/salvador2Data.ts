...
export const SALVADOR2_RESULTS: SearchResults = {
  ...
  alternatives: [
    ...
    {
      id: '5250924',
      name: 'Pousada Cor e Arte - Pelourinho',
      stars: 0,
      bookingScore: 0,
      reviewCount: 0,
      pricePerNight: 167.97,
      totalPrice: 167.97,
      nights: 1,
      currency: 'EUR',
      address: '25 Largo do Pelourinho',
      lat: -12.970885,
      lng: -38.508053,
      bookingUrl: 'https://www.booking.com/hotel/br/cor-e-arte-pelourinho.html?aid=8132308&checkin=2026-08-21&checkout=2026-08-22&no_rooms=1&group_adults=3&group_children=1&age=15&selected_currency=EUR',
      imageUrl: '',
      facilities: ['ac', 'airport_shuttle', 'wifi'],
      isAvailable: true,
      vfmScore: 22,
